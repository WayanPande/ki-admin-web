...
function RouteComponent() {
  ...
  const formAdd = useForm({
    ...
    validators: {
      onSubmit: z.object({
        instansi_id: z.string().min(2, "Name must be at least 2 characters"),
        ...
        latitude: z.string().min(2, "Name must be at least 2 characters"),
        longitude: z.string().min(2, "Name must be at least 2 characters"),
        pic_name: z.string().min(2, "Name must be at least 2 characters"),
        pic_phone: z.string().min(2, "Name must be at least 2 characters"),
        pic_email: z.string().min(2, "Name must be at least 2 characters"),
        pic_id: z.string().min(2, "Name must be at least 2 characters"),
        id: z.any().and(z.any()),
